...
import com.example.login.ui.leave_management.LeaveDetailsPOJO;
...
public class TableActivity extends AppCompatActivity {
    ...
    public void startLoadData() {
        ...
        mProgressBar.setMessage("Fetching Leave Request Details..");
    ...
    public ArrayList<LeaveDetailsPOJO> parseJSON(String result) {
        Log.d(TAG, "Result: response :: " + result);
        ArrayList<LeaveDetailsPOJO> leaveDetailsPOJOArrayList = new ArrayList<>();
        try {
            JSONObject jsonObject = new JSONObject(result);
            JSONArray jsonArray = jsonObject.getJSONArray("data");
            for (int i = 0; i < jsonArray.length(); i++) {
                JSONObject jsonData = jsonArray.getJSONObject(i);
                LeaveDetailsPOJO leaveDetailsPOJO = new LeaveDetailsPOJO();
                leaveDetailsPOJO.setEmployee_name(jsonData.getString("employee_name"));
                Log.d(TAG, "employee_name: response :: " + leaveDetailsPOJO.getEmployee_name());
                leaveDetailsPOJO.setEmployee_leaveCount(jsonData.getString("leave_count"));
                Log.d(TAG, "leave_count: response :: " + leaveDetailsPOJO.getEmployee_leaveCount());

                leaveDetailsPOJOArrayList.add(leaveDetailsPOJO);
            }
        ...
        return leaveDetailsPOJOArrayList;
    }
}
...
/*
  public void loadData() {
        ...
        LeaveDetailsPOJO leaveDetailsPOJO = new LeaveDetailsPOJO();
        LeaveDetailsPOJO[] leaveDetailsPOJOS= parseJSON();
